...
void vdp_set_reg(int reg, unsigned char value)
{
    ...
    if (!BIT(vdp_regs[0x1], 2) && reg > 0xA) return;
...
void vdp_write_memory_16(unsigned int address, unsigned int value) {
    switch(address &0x1F) {
        case 0x0:
        case 0x2: vdp_write_data_port_16(value); return;
        case 0x4:
        case 0x6: vdp_control_port_write(value); return;
        case 0x18:
            // VDP FIFO TEST
            return;
        case 0x1C:
...
unsigned int vdp_read_memory_16(unsigned int address)
{
    ...
    switch(address &0x1F) {
        case 0x0:
        case 0x2: return vdp_read_data_port_16();
        case 0x4:
        case 0x6: return vdp_status;
        case 0x8:
        case 0xA:
        case 0xC:
        case 0xE: return vdp_hvcounter_read_16(address);
        case 0x18:
            // VDP FIFO TEST
            return 0xFFFF;
        case 0x1C:
